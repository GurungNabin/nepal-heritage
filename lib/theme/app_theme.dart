...
/// A class that contains all theme configurations for the cultural heritage application.
class AppTheme {
  AppTheme._();

  // Heritage Earth Palette - Colors inspired by traditional Nepalese art and architecture
  static const Color primaryLight = Color(0xFF8B4513); // Warm temple brown
  static const Color primaryVariantLight =
      Color(0xFF654321); // Darker temple brown
  static const Color secondaryLight =
      Color(0xFFCD853F); // Supporting sandy tone
  static const Color secondaryVariantLight =
      Color(0xFFDEB887); // Lighter sandy tone
  ...
  static const Color errorLight =
      Color(0xFFD32F2F); // Standard Material error red
  static const Color successLight = Color(0xFF388E3C); // Forest green
  ...
  static const Color primaryDark =
      Color(0xFFCD853F); // Sandy tone for dark mode
  static const Color primaryVariantDark =
      Color(0xFF8B4513); // Temple brown variant
  static const Color secondaryDark = Color(0xFFFF6B35); // Saffron accent
  static const Color secondaryVariantDark =
      Color(0xFFFF8A65); // Lighter saffron
  static const Color accentDark = Color(0xFFFFAB40); // Bright amber
  ...
  static const Color warningDark = Color(0xFFFFB74D); // Light amber
  ...
  // Shadow colors - Subtle Material elevation system
  static const Color shadowLight = Color(0x1F000000); // 12% opacity
  static const Color shadowDark = Color(0x1FFFFFFF);

  // Divider colors - Minimal borders
  static const Color dividerLight = Color(0x33212121); // 20% opacity of primary
  ...
  static const Color textSecondaryLight = Color(0xFF757575); // Subtle gray
  ...
  /// Light theme - Contemporary Cultural Minimalism
  static ThemeData lightTheme = ThemeData(
    ...
    // Contextual App Bar - Adaptive toolbar
    ...
    // Adaptive Navigation - Bottom navigation
    ...
    // Floating Action Patterns - Context-aware FABs
    ...
    // Form elements with cultural aesthetics
    ...
    // Tab bar for timeline navigation
    ...
    // Drawer theme for deep content navigation
  ...
  /// Dark theme - Contemplative Discovery in dark mode
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles - Inter for UI titles
